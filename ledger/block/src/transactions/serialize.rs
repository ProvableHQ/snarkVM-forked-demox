    ...
    fn sample_transactions(index: u32, rng: &mut TestRng) -> Transactions<CurrentNetwork> {
        if index == 0 {
            ...
            [
                ...
                crate::transactions::confirmed::test_helpers::sample_rejected_execute(2, false, false, rng),
            ...
            [
                ...
                crate::transactions::confirmed::test_helpers::sample_rejected_execute(3, true, false, rng),
                crate::transactions::confirmed::test_helpers::sample_accepted_execute(4, false, rng),
                crate::transactions::confirmed::test_helpers::sample_rejected_execute(5, false, false, rng),
