...
pub mod test_helpers {
    ...
    pub(crate) fn sample_rejected_transactions() -> Vec<Rejected<CurrentNetwork>> {
        ...
        vec![
            ...
            sample_rejected_deployment(3, 0, true, rng),
            sample_rejected_deployment(3, 0, false, rng),
            ...
            sample_rejected_deployment(3, 1, true, rng),
            sample_rejected_deployment(3, 1, false, rng),
